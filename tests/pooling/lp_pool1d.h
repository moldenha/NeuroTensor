...
nt::Tensor lp_pool1d(nt::Tensor input, nt::Scalar power, int64_t kernel_size, int64_t stride = -1, bool ceil_mode = false){
    using namespace nt;
...
nt::Tensor backward_lp_pool1d(nt::Tensor input, nt::Tensor output_grad, 
                                nt::Scalar power, int64_t kernel_size, int64_t stride = -1,
...
nt::Tensor adaptive_lp_pool1d(nt::Tensor x, int64_t l_out, nt::Scalar power){
    using namespace nt;
