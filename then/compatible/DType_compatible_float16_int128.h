#ifndef __DTYPE_COMPATIBLE_FLOAT16_INT128_H__
#define __DTYPE_COMPATIBLE_FLOAT16_INT128_H__
...
using AllTypesL = DTypeEnum<DType::Integer, DType::Byte, DType::Short, DType::UnsignedShort, DType::LongLong, DType::Long, DType::int128, DType::uint128, DType::Float, DType::Double, DType::Float16, DType::Complex128, DType::Complex64, DType::Complex32, DType::Bool, DType::TensorObj>;
using AllTypesNBoolL = DTypeEnum<Type::Integer, DType::Byte, DType::Short, DType::UnsignedShort, DType::LongLong, DType::Long, DType::int128, DType::uint128, DType::Float, DType::Double, DType::Float16, DType::Complex128, DType::Complex64, DType::Complex32, DType::TensorObj>;
using NumberTypesL = DTypeEnum<Type::Integer, DType::Byte, DType::Short, DType::UnsignedShort, DType::LongLong, DType::Long, DType::int128, DType::uint128, DType::Float, DType::Double, DType::Float16, DType::Complex128, DType::Complex64, DType::Complex32>; 
using RealNumberTypesL = DTypeEnum<Type::Integer, DType::Byte, DType::Short, DType::UnsignedShort, DType::LongLong, DType::Long, DType::int128, DType::uint128, DType::Float, DType::Double, DType::Float16>; 
...
template <DType dt>
inline static constexpr bool dtype_is_num = is_in_v<dt, DType::uint128, DType::int128, DType::Float16, DType::Complex32, DType::Integer, DType::Long, DType::uint8, DType::int8, DType::int16, DType::int64, DType::uint64, DType::Float, DType::Double, DType::Complex128, DType::Complex64>;
