...
_NT_DEFINE_FUNCTIONAL_SINGLE_LAYER_(Sinh, sinh)
_NT_DEFINE_FUNCTIONAL_SINGLE_LAYER_(Sin, sin)
_NT_DEFINE_FUNCTIONAL_SINGLE_LAYER_(Cosh, cosh)
_NT_DEFINE_FUNCTIONAL_SINGLE_LAYER_(Cos, cos)
