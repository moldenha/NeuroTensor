#ifndef NT_LAYERS_CONV1D_H_
#define NT_LAYERS_CONV1D_H_
...
class NEUROTENSOR_API Conv1D : public Module {
  public:
    ...
    NT_MAKE_NAMED_ARGUMENT_CLASS_CONSTRUCTOR_(Conv1D,
        ...
        NT_NAMED_CLASS_CONSTRUCTOR_CLASS_ARG_TYPES_(int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, bool));
