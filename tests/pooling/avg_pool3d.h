...
nt::Tensor avg_pool3d_ceil(nt::Tensor input, nt::utils::my_n_tuple<3> kernel_size, nt::utils::my_n_tuple<3> stride, nt::utils::my_n_tuple<3> padding,
...
nt::Tensor backward_avg_pool3d_ceil(nt::SizeRef in_shape, nt::Tensor output_grad, nt::utils::my_n_tuple<3> kernel_size, nt::utils::my_n_tuple<3> stride, 
                                    nt::utils::my_n_tuple<3> padding,
                                    bool count_include_pad, int64_t modD, int64_t modR, int64_t modC){
    using namespace nt;
...
nt::Tensor backward_avg_pool3d(nt::SizeRef in_shape, nt::Tensor output_grad, 
...
nt::Tensor adaptive_avg_pool3d(nt::Tensor x, nt::utils::my_n_tuple<3> out_shape){
    using namespace nt;
