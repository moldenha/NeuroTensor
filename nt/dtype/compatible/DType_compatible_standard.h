#ifndef __DTYPE_COMPATIBLE_STANDARD_H__
#define __DTYPE_COMPATIBLE_STANDARD_H__
...
using FloatingTypesL = DTypeEnum<DType::Float64, DType::Float32>;
...
using AllTypesL = DTypeEnum<DType::Integer, DType::Byte, DType::Short, DType::UnsignedShort, DType::LongLong, DType::Long, DType::Float, DType::Double, DType::Complex128, DType::Complex64, DType::Bool, DType::TensorObj>;
using AllTypesNBoolL = DTypeEnum<Type::Integer, DType::Byte, DType::Short, DType::UnsignedShort, DType::LongLong, DType::Long, DType::Float, DType::Double, DType::Complex128, DType::Complex64, DType::TensorObj>;
using NumberTypesL = DTypeEnum<Type::Integer, DType::Byte, DType::Short, DType::UnsignedShort, DType::LongLong, DType::Long, DType::Float, DType::Double, DType::Complex128, DType::Complex64>; 
using RealNumberTypesL = DTypeEnum<Type::Integer, DType::Byte, DType::Short, DType::UnsignedShort, DType::LongLong, DType::Long, DType::Float, DType::Double>; 
...
template<DType dt>
constexpr bool is_convertible_to_floating = (size_of_dtype<dt> == 8 || size_of_dtype<dt> == 4);
template<DType dt>
inline constexpr DType convert_to_floating = size_of_dtype<dt> == 8 ? DType::Float64 : size_of_dtype<dt> == 4 ? DType::Float32 : DType::Bool;
