...
inline static constexpr auto col2im_cpu_1d = [](auto data_im_ptr, auto data_im_ptr_end, auto data_col,
...
void fold1d_(ArrayVoid &im, ArrayVoid &col, const int64_t& channels,
    const int64_t& width,
    const int64_t& k_w,
    const int64_t& s_w,
    const int64_t& p_w,
