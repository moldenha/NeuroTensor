...
inline static constexpr auto col2im_cpu_1d_backward = [](auto data_im_ptr, auto data_im_ptr_end, auto data_col,
...
void fold1d_backward_(ArrayVoid &output, ArrayVoid &grad, const int64_t& channels,
    const int64_t& width,
    const int64_t& k_w,
    const int64_t& s_w,
    const int64_t& p_w,
