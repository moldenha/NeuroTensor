#ifndef NT_LAYERS_CONV3D_H_
#define NT_LAYERS_CONV3D_H_
...
class NEUROTENSOR_API Conv3D : public Module {
  public:
    ...
    NT_MAKE_NAMED_ARGUMENT_CLASS_CONSTRUCTOR_(Conv3D,
        ...
        NT_NAMED_CLASS_CONSTRUCTOR_CLASS_ARG_TYPES_(int64_t, int64_t, utils::my_n_tuple<3>, utils::my_n_tuple<3>, utils::my_n_tuple<3>, utils::my_n_tuple<3>, int64_t, bool));
