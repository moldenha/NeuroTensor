#ifndef __DTYPE_COMPATIBLE_FLOAT16_H___
#define __DTYPE_COMPATIBLE_FLOAT16_H___ 
...
using FloatingTypesL = DTypeEnum<DType::Float64, DType::Float32, DType::Float16>;
...
using AllTypesL = DTypeEnum<DType::Integer, DType::Byte, DType::Short, DType::UnsignedShort, DType::LongLong, DType::Long, DType::Float, DType::Double, DType::Float16, DType::Complex128, DType::Complex64, DType::Complex32, DType::Bool, DType::TensorObj>;
using AllTypesNBoolL = DTypeEnum<Type::Integer, DType::Byte, DType::Short, DType::UnsignedShort, DType::LongLong, DType::Long, DType::Float, DType::Double, DType::Float16, DType::Complex128, DType::Complex64, DType::Complex32, DType::TensorObj>;
using NumberTypesL = DTypeEnum<Type::Integer, DType::Byte, DType::Short, DType::UnsignedShort, DType::LongLong, DType::Long, DType::Float, DType::Double, DType::Float16, DType::Complex128, DType::Complex64, DType::Complex32>; 
using RealNumberTypesL = DTypeEnum<Type::Integer, DType::Byte, DType::Short, DType::UnsignedShort, DType::LongLong, DType::Long, DType::Float, DType::Double, DType::Float16>; 
...
template<DType dt>
inline constexpr bool is_dtype_floating_v = is_in_v<dt, DType::Float, DType::Double,  DType::Float16>;
template<DType dt>
...
struct dtype_to_type{
	using type = std::conditional_t<is_in_v<DType::Integer, Rest...>, int32_t,
			std::conditional_t<is_in_v<DType::Float16, Rest...>, float16_t,
			std::conditional_t<is_in_v<DType::Complex32, Rest...>, complex_32,
...
template<DType dt>
constexpr bool is_convertible_to_complex = (size_of_dtype<dt> == 16 || size_of_dtype<dt> == 8 || size_of_dtype<dt> == 4);
template<DType dt>
inline constexpr DType convert_to_complex = size_of_dtype<dt> == 16 ? DType::Complex128 : size_of_dtype<dt> == 8 ? DType::Complex64 : size_of_dtype<dt> == 4 ? DType::Complex32 : DType::Bool;

template<DType dt>
constexpr bool is_convertible_to_floating = (size_of_dtype<dt> == 8 || size_of_dtype<dt> == 4 || size_of_dtype<dt> == 2);
template<DType dt>
inline constexpr DType convert_to_floating = size_of_dtype<dt> == 8 ? DType::Float64 : size_of_dtype<dt> == 4 ? DType::Float32 : size_of_dtype<dt> == 2 ? DType::Float16 : DType::Bool;

template<DType dt>
constexpr bool is_convertible_to_integer = (size_of_dtype<dt> == 8 || size_of_dtype<dt> == 4 || size_of_dtype<dt> == 2 || size_of_dtype<dt> == 1) && dt != DType::Bool;
template<DType dt>
inline constexpr DType convert_to_integer = size_of_dtype<dt> == 8 ? DType::int64 : size_of_dtype<dt> == 4 ? DType::int32 : size_of_dtype<dt> == 2 ? DType::int16 : size_of_dtype<dt> == 1 ? DType::int8 : DType::Bool;


template<DType dt>
constexpr bool is_convertible_to_unsigned = is_convertible_to_integer<dt>;
template<DType dt>
inline constexpr DType convert_to_integer = size_of_dtype<dt> == 8 ? DType::uint64 : size_of_dtype<dt> == 4 ? DType::uint32 : size_of_dtype<dt> == 2 ? DType::uint16 : size_of_dtype<dt> == 1 ? DType::uint8 : DType::Bool;
...
template <DType dt>
inline static constexpr bool dtype_is_num = is_in_v<dt, DType::Float16, DType::Complex32, DType::Integer, DType::Long, DType::uint8, DType::int8, DType::int16, DType::int64, DType::uint64, DType::Float, DType::Double, DType::Complex128, DType::Complex64>;
...
bool is_floating(const DType& dt){return ((dt == DType::Float) || (dt == DType::Double) || (dt == DType::Float16));}
bool is_complex(const DType& dt){return ((dt == DType::Complex64 ||dt == DType::Complex128 || dt == DType::Complex32));
...
constexpr DType next_dtype_it = (dt == DType::Bool ? DType::Integer
					: dt == DType::Integer ? DType::Float16
					: dt == DType::Float16 ? DType::Complex32
