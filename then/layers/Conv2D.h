#ifndef _NT_LAYERS_CONV2D_H_
#define _NT_LAYERS_CONV2D_H_
...
class Conv2D : public Module {
  public:
    ...
    _NT_MAKE_NAMED_ARGUMENT_CLASS_CONSTRUCTOR_(Conv2D,
        ...
        _NT_NAMED_CLASS_CONSTRUCTOR_CLASS_ARG_TYPES_(int64_t, int64_t, utils::my_tuple, utils::my_tuple, utils::my_tuple, utils::my_tuple, int64_t, bool));
