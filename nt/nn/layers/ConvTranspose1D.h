#ifndef NT_LAYERS_CONV_TRANSPOSE1D_H_
#define NT_LAYERS_CONV_TRANSPOSE1D_H_
...
class NEUROTENSOR_API ConvTranspose1D : public Module {
  public:
    bool use_bias;
    int64_t groups, in_channels, out_channels;
    int64_t stride, padding, output_padding, dilation;
    TensorGrad Weight, Bias;
    NT_MAKE_NAMED_ARGUMENT_CLASS_CONSTRUCTOR_(ConvTranspose1D,
        ...
        NT_NAMED_CLASS_CONSTRUCTOR_CLASS_ARG_TYPES_(int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, bool));
