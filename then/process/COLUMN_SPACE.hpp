#ifndef NT_LINALG_PROCESS_COLUMN_SPACE_HPP__
#define NT_LINALG_PROCESS_COLUMN_SPACE_HPP__ 
...
svd_col_space_eigen(
    ...
    if constexpr (detail::is_eigen_complex<T> || std::is_floating_point_v<T>) {
        Eigen::JacobiSVD<MatType> svd(mat, Eigen::ComputeThinU |
                                               Eigen::ComputeThinV);
