...
using AllTypesNBoolL = DTypeEnum<Type::Integer, DType::Byte, DType::Short, DType::UnsignedShort, DType::LongLong, DType::Long, DType::Float, DType::Double, DType::Float128, DType::Complex128, DType::Complex64, DType::TensorObj>;
using NumberTypesL = DTypeEnum<Type::Integer, DType::Byte, DType::Short, DType::UnsignedShort, DType::LongLong, DType::Long, DType::Float, DType::Double, DType::Float128, DType::Complex128, DType::Complex64>; 
:using RealNumberTypesL = DTypeEnum<Type::Integer, DType::Byte, DType::Short, DType::UnsignedShort, DType::LongLong, DType::Long, DType::Float, DType::Double, DType::Float128>; 
...
template <DType dt>
inline static constexpr bool dtype_is_num = is_in_v<dt, DType::Float128, DType::Integer, DType::Long, DType::uint8, DType::int8, DType::int16, DType::int64, DType::uint64, DType::Float, DType::Double, DType::Complex128, DType::Complex64>;
