#ifndef __DTYPE_COMPATIBLE_FLOAT16_FLOAT128_H___
#define __DTYPE_COMPATIBLE_FLOAT16_FLOAT128_H___ 
...
using AllTypesL = DTypeEnum<DType::Integer, DType::Byte, DType::Short, DType::UnsignedShort, DType::LongLong, DType::Long, DType::Float, DType::Double, DType::Float128, DType::Float16, DType::Complex128, DType::Complex64, DType::Complex32, DType::Bool, DType::TensorObj>;
using AllTypesNBoolL = DTypeEnum<Type::Integer, DType::Byte, DType::Short, DType::UnsignedShort, DType::LongLong, DType::Long, DType::Float, DType::Double, DType::Float128, DType::Float16, DType::Complex128, DType::Complex64, DType::Complex32, DType::TensorObj>;
using NumberTypesL = DTypeEnum<Type::Integer, DType::Byte, DType::Short, DType::UnsignedShort, DType::LongLong, DType::Long, DType::Float, DType::Double, DType::Float128, DType::Float16, DType::Complex128, DType::Complex64, DType::Complex32>; 
using RealNumberTypesL = DTypeEnum<Type::Integer, DType::Byte, DType::Short, DType::UnsignedShort, DType::LongLong, DType::Long, DType::Float, DType::Double, DType::Float128, DType::Float16>;
...
template<DType dt>
constexpr bool is_convertible_to_floating = (size_of_dtype<dt> == 16 || size_of_dtype<dt> == 8 || size_of_dtype<dt> == 4 || size_of_dtype<dt> == 2);
template<DType dt>
inline constexpr DType convert_to_floating = size_of_dtype<dt> == 16 ? DType::Float128 : size_of_dtype<dt> == 8 ? DType::Float64 : size_of_dtype<dt> == 4 ? DType::Float32 : size_of_dtype<dt> == 2 ? DType::Float16 : DType::Bool;
...
template <DType dt>
inline static constexpr bool dtype_is_num = is_in_v<dt, DType::Float16, DType::Float128, DType::Complex32, DType::Integer, DType::Long, DType::uint8, DType::int8, DType::int16, DType::int64, DType::uint64, DType::Float, DType::Double, DType::Complex128, DType::Complex64>;
...
bool is_floating(const DType& dt){return ((dt == DType::Float) || (dt == DType::Double) || (dt == DType::Float16) || (dt == DType::Float128));}
