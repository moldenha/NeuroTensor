...
_NT_MAKE_FUNCTIONAL_SINGLE_LAYER_(Sinh, tanh)
_NT_MAKE_FUNCTIONAL_SINGLE_LAYER_(Sin, sin)
_NT_MAKE_FUNCTIONAL_SINGLE_LAYER_(Cosh, cosh)
_NT_MAKE_FUNCTIONAL_SINGLE_LAYER_(Cos, cos)
