#ifndef NT_LAYERS_ADAPTIVE_AVG_POOL_3D_H_
#define NT_LAYERS_ADAPTIVE_AVG_POOL_3D_H_
...
namespace nt {
namespace layers {
class NEUROTENSOR_API AdaptiveAvgPool3D : public Module {
  public:
    utils::my_n_tuple<3> output_size;
    NT_MAKE_NAMED_ARGUMENT_CLASS_CONSTRUCTOR_(AdaptiveAvgPool3D,
        NT_NAMED_CLASS_CONSTRUCTOR_CLASS_ARG_NAMES_(output_size),
        NT_NAMED_CLASS_CONSTRUCTOR_CLASS_DEFAULT_VALS_(),
        NT_NAMED_CLASS_CONSTRUCTOR_CLASS_ARG_TYPES_(utils::my_n_tuple<3>));
